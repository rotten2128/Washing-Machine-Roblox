...
game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("T>h>i>s s>pi>n s.c>r>ip>t w>a>s> m>a>d>e b>y s>t>i>c>k>k>.")
-- Create a ScreenGui
...
speedTextLabel.Position = UDim2.new(0.5, -100, 1, -210) -- Position above the frame
